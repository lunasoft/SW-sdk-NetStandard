    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            try
            {
                ...
                AccountBalance balance = new AccountBalance("http://services.test.sw.com.mx", "http://api.test.sw.com.mx","user", "password");
    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            try
            {
                ...
                AccountBalance balance = new AccountBalance("http://services.test.sw.com.mx", "http://api.test.sw.com.mx", "T2lYQ0t4L0R....ReplaceForRealToken");
                Guid idUser = Guid.Parse("f0f11ef6-e4c5-425b-8fc9-b17465bf6f53");
                BalanceResponse response = await balance.ConsultarSaldoAsync(idUser);
                if (response.Status != "error")
                {
